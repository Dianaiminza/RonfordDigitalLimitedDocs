    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
      ...
      <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
          ...
          Welcome to Ronford Digital Docs
          </h2>
          <p class="mt-3 text-gray-600">
          We recommend you take a look at the <a href="../../content/en/index.md"
        target="_blank" class="button--doc text-green-500 hover:underline">SPG Documentation</a><br>
          </p>
          <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
          This document is a description of the integration process to the MuzuriPay API.The service enables bank and non-bank customers to make payments to merchant accounts at NCBA through multiple payment options.
          </p>
        </div>
        <div class="flex justify-center pt-4 space-x-2">
          <a href="https://github.com/ronford-digital" target="_blank"><svg
